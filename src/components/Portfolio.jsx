...
import nutritomatoImg from '../assets/images/nutritomato.png';
import brotalkImg from '../assets/images/brotalk.jpg';
import smartvisionImg from '../assets/images/smartvision.png';
import aicvcraftImg from '../assets/images/aicvcraft.png';

const projects = [
    {
        title: 'NutriTomato',
        category: 'Health SaaS',
        image: nutritomatoImg,
        tech: ['React', 'Node.js', 'Vercel'],
        links: { demo: 'https://nutritomato-frontend.vercel.app/', github: '#' }
    },
    {
        title: 'Bro Talk',
        ...
        image: brotalkImg,
        tech: ['React', 'Node.js', 'Vercel'],
        links: { demo: 'https://bro-talk-frontend.vercel.app/', github: '#' }
    },
    {
        title: 'Smart Vision AI',
        category: 'AI Object Detection',
        image: smartvisionImg,
        tech: ['React', 'AI', 'Lovable'],
        links: { demo: 'https://smartvisionai.lovable.app', github: '#' }
    },
    {
        title: 'AI CV Craft',
        category: 'AI SaaS',
        image: aicvcraftImg,
        tech: ['React', 'AI', 'Lovable'],
        links: { demo: 'https://ai-cv-craft-81.lovable.app', github: '#' }
    },
    {
